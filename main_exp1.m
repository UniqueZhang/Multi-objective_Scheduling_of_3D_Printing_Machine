...
[machine1,parts1,machine_data1,parts_data1]=data_input('C:\Users\ASUS\Desktop\BL\2\experiment1\Test instances of Che et al., 2021\ht100_3.txt');
%生成多组染色体并解码
...
[ F1_exp1, pop_exp1 , t_run] = ALGRANDOM(ObjFun, AlgOptions, ProbData,alldata)
%% 数据的存储
save('data_exp1\experiment1T1.mat','F1_exp1','pop_exp1');
